...
func newComment(db *gorm.DB, opts ...gen.DOOption) comment {
	...
	_comment.BlogID = field.NewInt32(tableName, "blog_id")
...
type comment struct {
	...
	ALL        field.Asterisk
	CommentID  field.Int32  // 评论ID，自增ID
	Content    field.String // 评论内容
	CreateTime field.Time   // 评论时间
	UserID     field.Int32  // 评论人ID
	BlogID     field.Int32  // 被评论的博客ID
...
func (c *comment) updateTableName(table string) *comment {
	...
	c.BlogID = field.NewInt32(table, "blog_id")
